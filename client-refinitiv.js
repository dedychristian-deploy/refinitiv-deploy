...
function sendMarketPriceRequest()
{
	const msg = {
		ID: 2,
		Key: {
			Name: ["BBNI.JK", "BBRI.JK", ".JKSE"],
			Service: "ELEKTRON_service"  // Ganti sesuai service valid kamu
		},
		View: ["TRDPRC_1", "NETCHNG_1", "PCTCHNG", "BID", "ASK", "ACVOL", "DSPLY_NAME"]
	};

	_websocket.send(JSON.stringify(msg));  // ✅ HARUS JSON.stringify
